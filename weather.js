...
function isItRaining(moistureLevel) {
	if( (typeof moistureLevel) !== 'number' ) throw Error('Moisture level must be a number.')
	else if( moistureLevel < 0 || moistureLevel > 1 ) throw Error('Moisture level must be between 0 and 1.')
